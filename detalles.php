		...
		<h2>Detalles</h2>
			<section>
				...
				<?php
					...
					$re=mysql_query("select * from Videojuego where IdVideojuego =".$_GET['IdVideojuego'])or die(mysql_error());
							
					while ($f=mysql_fetch_array($re)) {
					?>
						<center class = "Individual">
							<img src="./Imagenes/<?php echo $f['Imagen'];?>"><br>
							<span>Codigo: <?php echo $f['IdVideojuego'];?></span><br>
							<span><?php echo $f['Nombre'];?></span>
							<span>Precio $<?php echo $f['Precio'];?></span><br>
							<span>Solo para: <?php echo $f['Consola'];?></span><br><br>
